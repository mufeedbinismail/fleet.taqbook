...
class dimensions_app extends application
{
	function __construct()
	{
		...
		parent::__construct("proj", __($this->help_context = "&Dimensions"), $dim);

		if ($dim > 0)
		{
			$this->add_module(__("Transactions"));
			$this->add_lapp_function(0, __("Dimension &Entry"),
				"dimensions/dimension_entry.php?", 'SA_DIMENSION', MENU_ENTRY);
			$this->add_lapp_function(0, __("&Outstanding Dimensions"),

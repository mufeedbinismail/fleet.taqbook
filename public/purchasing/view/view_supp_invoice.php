...
$GLOBALS['page_security'] = Permission::VIEW_PURCHASE_TRANSACTION;
...
page(__($GLOBALS['help_context'] = "View Supplier Invoice"), true, false, "", $js);
...
display_heading(__("SUPPLIER INVOICE") . " # " . $trans_no);
echo "<br>";
...
if (!is_company_currency($supplier_curr_code))
	label_cells(__("Currency"), $supplier_curr_code, "class='tableheader2'");
end_row();
...
start_table(TABLESTYLE, "width='95%'");
label_row(__("Sub Total"), $display_sub_tot, "align=right", "nowrap align=right width='15%'");
...
label_row(__("TOTAL INVOICE").' ('.$supplier_curr_code.')', $display_total, "colspan=1 align=right", "nowrap align=right");

end_table(1);

$voided = is_voided_display(ST_SUPPINVOICE, $trans_no, __("This invoice has been voided."));

...
function print_supplier_balances()
{
	...
	$headers = array(__('Trans Type'), __('#'), __('Date'), __('Due Date'), __('Charges'),
    ...
    $rep = new FrontReport(__('Supplier Balances'), "SupplierBalances", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
